...
import { SampleCoin, TicketMarketplace, TicketNFT } from "../typechain-types";
...
describe("TicketMarketplace", function () {
  ...
  async function deployMarketplaceERC20() {
    ...
    const ticketNFT: TicketNFT = await TicketNFT.deploy();

    // Deploy TicketMarketplace with both addresses
